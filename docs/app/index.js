...
import { buildViewModel, totalDuration, formatDuration, yearOf, resolveAsset } from "./logic.js";
...
export function bookCard(doc, m, b) {
  ...
  a.innerHTML =
    ...
    `<div class="m">${vm.chapters.length} chapters · ${formatDuration(totalDuration(vm, vid))}</div>` +
    badge +
    `</div>`;
  return a;
}
...
export const QUEUE = [
  ...
  { id: "zhuangzi-machine-heart", title: "Zhuangzi: The Machine Heart",
    ...
    tags: ["technology", "consciousness", "east"] },
  { id: "upanishads-self", title: "The Katha & Mundaka Upanishads",
    subtitle: "the self that is not the instrument", author: "trans. R. E. Hume", year: "c. 500 BC",
    status: "queued", preview: [],
    note: "The chariot's rider, the two birds on one branch — the witness that is not the mind. The collection's deepest reach into consciousness.",
    tags: ["consciousness", "east"] },
  { id: "ashtavakra-gita", title: "The Ashtavakra Gita", subtitle: "non-duality, without hedging",
    author: "trans. John Richards", year: "c. 500 BC–14th c. AD", status: "queued", preview: [],
    note: "“You are awareness itself, the witness of all” — the starkest non-dual text there is. The purest “what am I really.”",
    tags: ["consciousness", "east"] },
  { id: "dhammapada", title: "The Dhammapada", subtitle: "“mind is the forerunner of all things”",
    author: "the Buddha (trad.)", year: "c. 3rd c. BC", status: "queued", preview: [],
    note: "The Buddhist voice in the same room — and the one that answers “no eternal self,” against the Upanishads. The dialogue, not a unison.",
    tags: ["consciousness", "east"] },
  { id: "cloud-of-unknowing", title: "The Cloud of Unknowing", subtitle: "the West's apophatic witness",
    author: "anon., ed. Underhill", year: "14th c.", status: "queued", preview: [],
    note: "“By love he may be gotten and holden; by thought never.” The Western mirror of neti neti — the mind at the edge of what it can know.",
    tags: ["consciousness", "west"] },
  { id: "erewhon-machines", title: "Erewhon: The Book of the Machines", subtitle: "",
    ...
    tags: ["technology", "consciousness", "modern", "fiction"] },
  { id: "the-machine-stops", title: "The Machine Stops", subtitle: "",
    ...
    tags: ["technology", "modern", "fiction"] },
